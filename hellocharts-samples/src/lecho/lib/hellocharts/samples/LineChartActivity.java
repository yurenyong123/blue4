...
public class LineChartActivity extends AppCompatActivity {
    ...
    public class PlaceholderFragment extends Fragment {
        ...
        private class BluetoothReciver extends BroadcastReceiver
        {
            ...
            public void onReceive(Context context, Intent intent) {
                String action= intent.getAction();
                 ...
                 if(intent.getAction().equals("android.intent.action.ServiceToLineChart")){
                    ...
                    int cmd = bundle.getInt("cmd");
                     ...
                     if (cmd==CMD_RETURN_DATA)
                     {
                         ...
                         templeText=bundle.getInt("value");
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            myTempleTextView1=(TextView)findViewById(R.id.templeTextView1);
        ...
        public void sendCmdBroadcast(int cmd){
            Intent intent = new Intent();//创建Intent对象
            intent.setAction("android.intent.action.cmd");
            if(cmd==CMD_GET_DATA) {
                intent.putExtra("cmd", CMD_GET_DATA);
            }
        ...
        private void generateData() {
           ...
           // myTempleTextView.setText(templeText);
            List<Line> lines = new ArrayList<Line>();
            for (int i = 0; i < numberOfLines; ++i) {

                List<PointValue> values = new ArrayList<PointValue>();
                for (int j = 0; j < numberOfPoints; ++j) {
                    values.add(new PointValue(j,templeText/2));
                }
//
